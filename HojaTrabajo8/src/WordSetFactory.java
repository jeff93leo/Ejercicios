...
modificado por : Jefferson Silva (12605), Pablo samayoa(12635), Ixim Cojti (12697) , Carlos Cordero () 
*/
...
class WordSetFactory {
	...
	public static WordSet generateSet(int tipo)
	{
            ...
            TreeMap quinto = new TreeMap ();
            Hashtable cuarto = new Hashtable();
